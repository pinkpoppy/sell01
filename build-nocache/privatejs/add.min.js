...
jQuery(function($){$.cxSelect.defaults.url='cityData.json'
$.cxSelect.defaults.nodata='none'
$('#element_id').cxSelect({selects:['province','city','area']});var
storage=app.appState.storageType
isStorageAvailable=app.methods.initStorage(storage)
keyArr=app.appState.storageArr
if(isStorageAvailable){s=window[storage]
if(s.length>=6){var
...
dede&&dede!="undefined"?$("#fill-de").attr("data-value",dede):$("#fill-de").attr("data-value","")}else{s.setItem(keyArr[0],"")
s.setItem(keyArr[1],"")
s.setItem(keyArr[2],"")
s.setItem(keyArr[3],"")
s.setItem(keyArr[4],"")
s.setItem(keyArr[5],"")}
$('#fill-name').change(function(){name=$(this).val()
s.setItem(keyArr[0],name)})
$('#fill-tel').change(function(){tel=$(this).val()
s.setItem(keyArr[1],tel)})
$('#fill-p').change(function(){p=$(this).val()
s.setItem(keyArr[2],p)})
$('#fill-c').change(function(){c=$(this).val()
s.setItem(keyArr[3],c)})
$('#fill-d').change(function(){d=$(this).val()
s.setItem(keyArr[4],d)})
$('#fill-de').change(function(){de=$(this).val()
s.setItem(keyArr[5],de)})}
$('#add-save').on('click',function(){history.back()})});