...
configUrlMap={APIBase:"http://t.snapwine.net:7784/pjapi/"},config={Base64Key:"RkVB2p5ida3ywUDJf7IgXcoGrm8TjOEAb",userId:localStorage['userId'],userType:"12",headPic:localStorage['headPic'],nickname:localStorage['nickname'],sex:localStorage['sex'],intro:'',country:localStorage['country'],pro:localStorage['province'],city:localStorage['city'],dis:''},localArr=['n','t','p','c','d','de'],browser={versions:function(){var
...
var
screenWidth=app.screenSize(),imgWidth=liWidth=parseInt(parseInt((screenWidth-26)/2)),ratio=1.0,imgHeight=Math.ceil(imgWidth*ratio),liBottomHeight=70,liHeight=imgHeight+liBottomHeight,winePic="";if(currentWine['pics'].length!=0){winePic=currentWine['pics'][0]['pic']}
var $li=$("<li></li>")
$(wrap).append($li)
